...
#'
#' @return the solution
greedy_knapsack <- function(knapsack, W) {
  # 1) "Smarter greedy"
...
# solve it: greedy_knapsack
a <- greedy_knapsack(knapsack = knapsack, W = W)
print(a)
